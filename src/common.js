	...
	insertItemOpr: function(from) {
		...
		$A(items).each(function(it, i) {
			if ( it && it.id && (it.id.indexOf(this.ITEM_PREFIX)==0) ) {
				...
				str += '<img src="http://js1.pp.sohu.com.cn/ppp/blog/styles_ppp/images/ico_edit.gif" title="修改" />';
				str += '</a>';
				...
				str += '<img src="http://js1.pp.sohu.com.cn/ppp/blog/styles_ppp/images/ico_del.gif" title="删除" />';
				str += '</a>';
				if (!it.innerHTML) {
					it.innerHTML = str;
				}
...
function checkCForm() {
	...
	var url = '/a/app/discuss/save.htm?_input_encode=UTF-8';
