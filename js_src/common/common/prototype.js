...
Ajax.Request = Class.create(Ajax.Base, {
  ...
  respondToReadyState: function(readyState) {
    ...
    if (state == 'Complete') {
      try {
        ...
        (this.options['on' + response.status]
         ...
         || Prototype.emptyFunction)(response, response.headerJSON, data);	// Todd Lee
      } catch (e) {
        this.dispatchException(e);
      }
    ...
    try {
      ...
      (this.options['on' + state] || Prototype.emptyFunction)(response, response.headerJSON, data);	// Todd Lee
...
Element.extend = (function() {
  ...
  var extend = Object.extend(function(element) {
    ...
    if (ByTag[tagName]) Object.extend(methods, ByTag[tagName]);
		...
		/**
		 * edit by jady, replace the below, because can't do this in a xml node:
