...
var o_olymToday = function(m_data, m_content, m_edit){
	...
	this.build = function(nocache) {
		...
		m_content.innerHTML = '';
		elmOutput.innerHTML = '<div><a href="http://zt.blog.sohu.com/s2008/olympic/" target="_blank"><img src="http://js2.pp.sohu.com.cn/ppp/blog/styles_ppp/images/olympic/olymBanner.jpg" /></a></div><div></div><div style="text-align:right;display:none;"><a target="_blank" href="">更多>></a></div>';
		m_content.appendChild(elmOutput);
		this.initEles();
		this.setTitle('今日头条', true);
		this.getScrap();
	};
	...
	this.getScrap = function(){
		...
		new Ajax.Request(
			url,
			{
				...
				onFailure: this.noData.bind(this,eles.news,'暂无今日头条')
			}
		);
	};
