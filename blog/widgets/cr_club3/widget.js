...
/*******************************************************/
var cr_club3 = function(m_data, m_content, m_edit){
	var elmOutput;
	var club3;
	var dataHost = 'http://i.chinaren.com/sf/statics/json/json_crclub_33.js';
        //var setsListPath = '/json/json_crblog.jsp?boardid=33';
	...
	this.showSetsList = function() {
		...
		str += '<a href="' + feed_33.img_url + '" target="_blank" >';
		str += '<img src="' + feed_33.img_src + '" alt="" width="200" />';
		str += '</a>';
		str += '</div>';
		...
		$A(feed_33.items).each(function(it, i){
		...
		elmDiv = document.createElement('div');
                ...
                elmDiv.innerHTML = '<a target="_blank" href="'+feed_33.htmlUrl+'">¸ü¶à>></a>';
                elmOutput.appendChild(elmDiv);
	};
