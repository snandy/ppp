...
/*******************************************************/
var cr_feature = function(m_data, m_content, m_edit){
	var elmOutput;
	var feature;
	var dataHost = 'http://i.chinaren.com/sf/statics/json/json_crblog_4.js';
        //var setsListPath = '/html/json_crblog.jsp?act=2&type=4';
	...
	this.showSetsList = function() {
		...
		$A(feednews_4.items).each(function(it, i){
		...
		var elmDiv = document.createElement('div');
                ...
                elmDiv.innerHTML = '<a target="_blank" href="'+feednews_4.htmlUrl+'">¸ü¶à>></a>';
