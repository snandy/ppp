...
/*******************************************************/
var cr_ding = function(m_data, m_content, m_edit){
	var elmOutput;
	var ding;
	var dataHost = 'http://i.chinaren.com/sf/statics/json/json_crblog_3.js';
        //var setsListPath = '/html/json_crblog.jsp?act=2&type=3';
	...
	this.showSetsList = function() {
		...
		$A(feednews_3.items).each(function(it, i){
		...
		var elmDiv = document.createElement('div');
                ...
                elmDiv.innerHTML = '<a target="_blank" href="'+feednews_3.htmlUrl+'">¸ü¶à>></a>';
