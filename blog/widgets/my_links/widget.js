...
var my_links = function(m_data, m_content, m_edit){
	/*
	var icoLib = {
	...
	*/
	this.saveData = function() {
		...
		if (this.getTitle() == $F(this.titleIpt).unescapeHTML()) {
			this.closeEdit();
			return;
		}
	...
	this.showContent = function() {
		//if (typeof linkList == 'undefined' || !linkList) {
			elmOutput.innerHTML = '功能维护中';
			return;
		//}
		//if (linkList.length === 0) {
			elmOutput.innerHTML = '没有任何链接';
		//	return;
		//}
		//elmOutput.innerHTML = '';
