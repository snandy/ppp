...
/*******************************************************/
var cr_campus = function(m_data, m_content, m_edit){
	var elmOutput;
	var campus;
	var dataHost = 'http://i.chinaren.com/sf/statics/json/json_crblog_2.js';
        //var setsListPath = '/html/json_crblog.jsp?act=2&type=2';
	...
	this.showSetsList = function() {
		...
		$A(feednews_2.items).each(function(it, i){
		...
		var elmDiv = document.createElement('div');
                ...
                elmDiv.innerHTML = '<a target="_blank" href="'+feednews_2.htmlUrl+'">¸ü¶à>></a>';
