...
/*******************************************************/
var cr_party = function(m_data, m_content, m_edit){
	var elmOutput;
	var party;
	var dataHost = 'http://i.chinaren.com/sf/statics/json/json_crblog_5.js';
        //var setsListPath = '/html/json_crblog.jsp?act=2&type=5';
	...
	this.showSetsList = function() {
		...
		$A(feednews_5.items).each(function(it, i){
		...
		var elmDiv = document.createElement('div');
                ...
                elmDiv.innerHTML = '<a target="_blank" href="'+feednews_5.htmlUrl+'">¸ü¶à>></a>';
