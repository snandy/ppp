...
/*******************************************************/
var cr_club4 = function(m_data, m_content, m_edit){
	var elmOutput;
	var club4;
	var dataHost = 'http://i.chinaren.com/sf/statics/json/json_crclub_34.js';
        //var setsListPath = '/json/json_crblog.jsp?boardid=34';
	...
	this.showSetsList = function() {
		...
		str += '<a href="' + feed_34.img_url + '" target="_blank" >';
		str += '<img src="' + feed_34.img_src + '" alt="" width="200" />';
		str += '</a>';
		str += '</div>';
		...
		$A(feed_34.items).each(function(it, i){
		...
		elmDiv = document.createElement('div');
                ...
                elmDiv.innerHTML = '<a target="_blank" href="'+feed_34.htmlUrl+'">¸ü¶à>></a>';
                elmOutput.appendChild(elmDiv);
	};
