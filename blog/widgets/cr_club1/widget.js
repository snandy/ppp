...
/*******************************************************/
var cr_club1 = function(m_data, m_content, m_edit){
	var elmOutput;
	var club1;
	var dataHost = 'http://i.chinaren.com/sf/statics/json/json_crclub_4.js';
	//var setsListPath = '/json/json_crblog.jsp?boardid=4';
	...
	this.showSetsList = function() {
		...
		//var title = '<a href="'+ feed_4.htmlUrl +'" target="_blank" title="'+ feed_4.title +'">'+ feed_4.title +'</a>';
		//this.setTitle(title);
		...
		str += '<a href="' + feed_4.img_url + '" target="_blank" >';
		str += '<img src="' + feed_4.img_src + '" alt="" width="200" />';
		str += '</a>';
		str += '</div>';
		...
		$A(feed_4.items).each(function(it, i){
		...
		elmDiv.innerHTML = '<a target="_blank" href="'+feed_4.htmlUrl+'">¸ü¶à>></a>';
		elmOutput.appendChild(elmDiv);
	};
