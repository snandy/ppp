...
/*******************************************************/
var cr_focus = function(m_data, m_content, m_edit){
	var elmOutput;
	var forcus;
	var dataHost = 'http://i.chinaren.com/sf/statics/json/json_crblog_1.js';
        //var setsListPath = '/html/json_crblog.jsp?act=2&type=1';
	...
	this.showSetsList = function() {
		...
		$A(feednews_1.items).each(function(it, i){
		...
		var elmDiv = document.createElement('div');
                ...
                elmDiv.innerHTML = '<a target="_blank" href="'+feednews_1.htmlUrl+'">¸ü¶à>></a>';
